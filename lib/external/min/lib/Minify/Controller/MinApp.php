    ...
    public function setupSources($options) {
        ...
        if (isset($_GET['g'])) {
            ...
            foreach ((array)$cOptions['allowDirs'] as $allowDir) {
                //ALVA: $allowDirs[] = realpath(str_replace('//', $_SERVER['DOCUMENT_ROOT'] . '/', $allowDir));
                $allowDirs[] = $allowDir;
            }
            foreach ($files as $file) {
                //ALVA: $path = $_SERVER['DOCUMENT_ROOT'] . $base . $file;
                $path = dirname(__FILE__) . '/../../../../../..' . $base . $file;
                $file = realpath($path);
                if (false === $file) {
                ...
                /*
                 * ALVA: it is a bad implementation anyway...
